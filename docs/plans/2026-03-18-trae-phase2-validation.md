...
**涉及文件：**
- 修改：`/Volumes/Data/code/MyCode/ForgeFlow/README.md`
- 修改：`/Volumes/Data/code/MyCode/ForgeFlow/docs/onboarding.md`
- 参考：`/Volumes/Data/code/MyCode/ForgeFlow/packages/mcp-trae-worker/src/server.ts`
- 参考：`/Volumes/Data/code/MyCode/ForgeFlow/scripts/run-trae-mcp-worker-server.mjs`
...
**涉及文件：**
- 运行：`/Volumes/Data/code/MyCode/ForgeFlow/scripts/run-dispatcher-server.mjs`
- 运行：`/Volumes/Data/code/MyCode/ForgeFlow/scripts/run-trae-mcp-worker-server.mjs`
- 观察：`/Volumes/Data/code/MyCode/ForgeFlow/scripts/lib/dispatcher-server.mjs`
- 业务仓：`/Volumes/Data/code/MyCode/openclaw-multi-agent-mvp`
...
要求：
- `allowedPaths = ["docs/**"]`
- `repo_dir = /Volumes/Data/code/MyCode/openclaw-multi-agent-mvp`
...
**涉及文件：**
- 观察：`/Volumes/Data/code/MyCode/ForgeFlow/scripts/lib/dispatcher-state.mjs`
- 观察：`/Volumes/Data/code/MyCode/ForgeFlow/scripts/lib/dispatcher-server.mjs`
- 观察：`/Volumes/Data/code/MyCode/ForgeFlow/packages/mcp-trae-worker/src/server.ts`
...
**涉及文件：**
- 修改：`/Volumes/Data/code/MyCode/ForgeFlow/docs/plans/2026-03-18-trae-phase2-validation.md`
