...
import {
  buildDriverConfig as buildCoreDriverConfig,
  createTraeAutomationDriver as createCoreTraeAutomationDriver,
} from "@tingrudeng/automation-gateway-core";
...
export function buildDriverConfig(options: import("@tingrudeng/automation-gateway-core").DriverOptions = {}) {
...
export function createTraeAutomationDriver(
  options: import("@tingrudeng/automation-gateway-core").TraeAutomationDriverOptions = {},
) {
