...
export const Layout: React.FC<LayoutProps> = ({ children, updatedAt, isConnecting }) => {
  ...
  return (
    <div className="min-h-screen text-foreground font-sans selection:bg-primary selection:text-black">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-4 sm:py-6 flex flex-col gap-5 sm:gap-6">
        <header className="glass rounded-2xl px-4 sm:px-6 py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-6">
            ...
            <div className="glass-button rounded-full px-4 py-2 text-xs font-semibold text-white/70 flex items-center gap-3 max-w-full">
              <div className={cn(
