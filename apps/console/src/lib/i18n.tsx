...
const I18N = {
  zh: {
    ...
    endedAt: '结束时间',
    artifactBundle: '产物包',
    artifactWorkbench: '产物审查工作台',
    artifactSearchPlaceholder: '按任务、仓库、摘要、文件或引用筛选',
    artifactSummary: '产物摘要',
    artifactRefs: '引用',
    artifactRetainedContent: '正文',
    artifactTrajectory: '轨迹',
    copyArtifactRef: '复制引用',
    openArtifactFile: '展开文件',
    downloadArtifactFile: '下载文件',
    artifactFileLoadFailed: '读取产物文件失败',
    copied: '已复制',
    summary: '摘要',
    changedFiles: '变更文件',
    riskNotes: '风险备注',
  ...
  en: {
    ...
    artifactWorkbench: 'Artifact Review Workbench',
    artifactSearchPlaceholder: 'Filter by task, repo, summary, file, or ref',
    artifactSummary: 'Artifact Summary',
    artifactRefs: 'Refs',
    artifactRetainedContent: 'Retained',
    artifactTrajectory: 'Trajectory',
    copyArtifactRef: 'Copy ref',
    openArtifactFile: 'Open file',
    downloadArtifactFile: 'Download file',
    artifactFileLoadFailed: 'Failed to read artifact file',
    copied: 'Copied',
    summary: 'Summary',
